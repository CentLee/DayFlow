...
5. Implementation work applies global `ponytail` at `full` intensity through `.codex/skills/dayflow-implementation/SKILL.md`: narrow discovery, minimum coherent diff, focused tests, and no speculative architecture.
